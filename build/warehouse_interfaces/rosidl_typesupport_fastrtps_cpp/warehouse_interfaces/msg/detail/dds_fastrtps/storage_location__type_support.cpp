...
#include "warehouse_interfaces/msg/detail/storage_location__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const warehouse_interfaces::msg::StorageLocation & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  warehouse_interfaces::msg::StorageLocation & ros_message)
{
  // Member: location_id
  cdr >> ros_message.location_id;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = warehouse_interfaces::msg::StorageLocation;
    is_plain =
      (
      offsetof(DataType, z) +
      last_member_size
...
{
  auto typed_message =
    static_cast<const warehouse_interfaces::msg::StorageLocation *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<warehouse_interfaces::msg::StorageLocation *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _StorageLocation__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const warehouse_interfaces::msg::StorageLocation *>(
...
static size_t _StorageLocation__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_StorageLocation(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _StorageLocation__callbacks = {
...
static rosidl_message_type_support_t _StorageLocation__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_StorageLocation__callbacks,
...
{
  return &warehouse_interfaces::msg::typesupport_fastrtps_cpp::_StorageLocation__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, warehouse_interfaces, msg, StorageLocation)() {
  return &warehouse_interfaces::msg::typesupport_fastrtps_cpp::_StorageLocation__handle;
}
