...
static const _DetectedProduct_type_support_symbol_names_t _DetectedProduct_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, warehouse_interfaces, msg, DetectedProduct)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, warehouse_interfaces, msg, DetectedProduct)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, warehouse_interfaces, msg, DetectedProduct)() {
  return &::warehouse_interfaces::msg::rosidl_typesupport_c::DetectedProduct_message_type_support_handle;
}
